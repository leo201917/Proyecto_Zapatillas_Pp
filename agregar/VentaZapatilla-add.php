...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    onSubmit="return validate();">
      ...
      <div>
      <div>
        <label style="padding-top: 20px;">Fecha Emisión</label> <span
      ...
      <label style="padding-top: 20px;">Empresa a Facturar</label> <span
            ...
            $db_handle_EF = new DBController();
            $empresaFacturar_ef = new EmpresaFacturar();
            $resultCombo = $empresaFacturar_ef->getallEmpresaFacturar();
            foreach ($resultCombo as $k => $v):
            echo '<option value="'. $resultCombo[$k]["codigoEmpresaFacturar"].'">'. $resultCombo  [$k]["ruc"] , ' - ' ,$resultCombo  [$k]["razonSocial"].'</option>';
            endforeach;
            ?>
            </select>   
      </div>
      ...
      <label style="padding-top: 20px;">Cliente</label> <span
            ...
            $db_handle_CI = new DBController();
            $cliente_ci = new Cliente();
            $resultCombo = $cliente_ci->getallCliente();
            foreach ($resultCombo as $k => $v):
    ...
    <div>
        <input type="submit" name="add" id="btnSubmit" value="Continuar" />
    </div>
