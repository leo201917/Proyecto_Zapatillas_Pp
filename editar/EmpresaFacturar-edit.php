      ...
      <div class="content-wrapper">
       ...
       <form name="frmAdd" method="post" action="" id="frmAdd"
         ...
         <div id="mail-status">
           ...
           <div>
        <label style="padding-top: 20px;">Ruc</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="ruc" id="ruc" class="demoInputBox"
            value="<?php echo $result[0]["ruc"]; ?>"><br>
        <label style="padding-top: 20px;">Razon Social</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="razonSocial" id="razonSocial" class="demoInputBox"
            value="<?php echo $result[0]["razonSocial"]; ?>"><br>
        <label style="padding-top: 20px;">Dirección Fiscal</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="direccionFiscal" id="direccionFiscal" class="demoInputBox"
            value="<?php echo $result[0]["direccionFiscal"]; ?>"><br>
        <label style="padding-top: 20px;">Estado Empresa</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="estadoEmpresa" id="estadoEmpresa" class="demoInputBox"
            value="<?php echo $result[0]["estadoEmpresa"]; ?>">
    </div> 
    <div>
...
function validate() {
    ...
    if(!$("#ruc").val()) {
        ...
        $("#ruc").css('background-color','#FFFFDF');
        valid = false;
    }

    if(!$("#razonSocial").val()) {
        $("#name-info").html("(required)");
        $("#razonSocial").css('background-color','#FFFFDF');
        valid = false;
    }

    if(!$("#direccionFiscal").val()) {
        $("#name-info").html("(required)");
        $("#direccionFiscal").css('background-color','#FFFFDF');
        valid = false;
    }

    if(!$("#estadoEmpresa").val()) {
        $("#name-info").html("(required)");
        $("#estadoEmpresa").css('background-color','#FFFFDF');
        valid = false;
    }
