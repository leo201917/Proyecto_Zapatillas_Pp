      ...
      <div class="content-wrapper">
       ...
       <form name="frmAdd" method="post" action="" id="frmAdd"
         ...
         <div id="mail-status">
           ...
           <div>
            <label style="padding-top: 20px;">Stock Minimo</label> <span
            id="name-info" class="info"></span><br /> <input type="number"
            name="stockMinimo" id="stockMinimo" class="demoInputBox"
            value="<?php echo $result[0]["stockMinimo"]; ?>"><br>
            
            <label style="padding-top: 20px;">Stock Maximo  </label> <span
            id="name-info" class="info"></span><br /> <input type="number"
            name="stockMaximo" id="stockMaximo" class="demoInputBox"
            value="<?php echo $result[0]["stockMaximo"]; ?>"><br>

            <label style="padding-top: 20px;">Zapatilla</label> <span
            id="name-info" class="info"></span><br /> 

            <select class="form-control" width = "20"  name = "codigoZapatilla" id = "codigoZapatilla">
            <option value=""><?php echo $result[0]["codigoZapatilla"]; ?></option>
            <?php
            require_once "../model/Zapatilla.php";
            $codigo_Zap = $result[0]["codigoZapatilla"];
            $db_handle_Z = new DBController();
            $zapatilla_z = new Zapatilla();
            $resultCombo = $zapatilla_z->getallZapatilla($codigo_Zap);
            ...
            function getval(sel)
{
    ...
    <script>
   var seleccion_Objeto = <?php echo $result[0]["codigoZapatilla"]; ?>
   alert (seleccion_Objeto);
 const select = document.getElementById('codigoZapatilla');
select.value = seleccion_Objeto;
...
function validate() {
    ...
    if(!$("#stockMinimo").val()) {
        ...
        $("#stockMinimo").css('background-color','#FFFFDF');
        valid = false;
    }
    if(!$("#stockMaximo").val()) {
        $("#name-info").html("(required)");
        $("#stockMaximo").css('background-color','#FFFFDF');
        valid = false;
    }
