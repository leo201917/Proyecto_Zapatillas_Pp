    ...
    <div class="app-content content container-fluid">
      <div class="content-wrapper">
       ...
       <form name="frmAdd" method="post" action="" id="frmAdd"
         ...
         <div id="mail-status">
         <!-- <input type="text"name="name"  id="mail-status"  value="<?php echo $result[0]["codigoZapatilla"]; ?>"> -->
         </div>
           <div>
