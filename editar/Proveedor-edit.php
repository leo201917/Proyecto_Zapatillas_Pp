    ...
    <div class="app-content content container-fluid">
      <div class="content-wrapper">
       ...
       <form name="frmAdd" method="post" action="" id="frmAdd"
         ...
         <div id="mail-status">
         <!-- <input type="text"name="name"  id="mail-status"  value="<?php echo $result[0]["codigoProveedor"]; ?>"> -->
         </div>
           <div>
            ...
            <label style="padding-top: 20px;">Telefono</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="telefono" id="telefono" class="demoInputBox"
            value="<?php echo $result[0]["telefono"]; ?>"><br>
            <label style="padding-top: 20px;">Correo</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="correo" id="correo" class="demoInputBox"
            value="<?php echo $result[0]["correo"]; ?>"><br>
            <label style="padding-top: 20px;">Direccion</label> <span
            id="name-info" class="info"></span><br /> <input type="text"
            name="direccion" id="direccion" class="demoInputBox"
            value="<?php echo $result[0]["direccion"]; ?>"><br>
...
function validate() {
    ...
    if(!$("#direccion").val()) {
        $("#name-info").html("(required)");
        $("#direccion").css('background-color','#FFFFDF');
        valid = false;
    }
