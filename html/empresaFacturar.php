...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=EmpresaFacturar-add"><img src="../image/icon-add.png" />Agregar Empresa a Facturar</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO EMPRESA A FACTURAR</strong></th>
                    <th><strong>RUC</strong></th>
                    <th><strong>RAZON SOCIAL</strong></th>
                    <th><strong>DIRECCION FISCAL</strong></th>
                    <th><strong>ESTADO EMPRESA</strong></th>
          ...
          <tr>
                    ...
                    <td><?php echo $result[$k]["ruc"]; ?></td>
                    <td><?php echo $result[$k]["razonSocial"]; ?></td>
                    <td><?php echo $result[$k]["direccionFiscal"]; ?></td>
                    <td><?php echo $result[$k]["estadoEmpresa"]; ?></td>
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=EmpresaFacturar-edit&codigoEmpresaFacturar=<?php echo $result[$k]["codigoEmpresaFacturar"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=EmpresaFacturar-delete&codigoEmpresaFacturar=<?php echo $result[$k]["codigoEmpresaFacturar"]; ?>">
