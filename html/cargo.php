...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=Cargo-add"><img src="../image/icon-add.png" />Agregar Cargo</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO CARGO</strong></th>
          ...
          <tr>
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=Cargo-edit&codigoCargo=<?php echo $result[$k]["codigoCargo"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=Cargo-delete&codigoCargo=<?php echo $result[$k]["codigoCargo"]; ?>">
