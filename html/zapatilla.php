...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=Zapatilla-add"><img src="../image/icon-add.png" />Agregar Zapatilla</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO ZAPATILLA</strong></th>
                    <th><strong>MARCA</strong></th>
                    <th><strong>MODELO</strong></th>
                    <th><strong>TALLA</strong></th>
                    <th><strong>COLOR</strong></th>
                    <th><strong>PRECIO ORIGEN</strong></th>
                    <th><strong>PORCENTAJE GANANCIA</strong></th>
          ...
          <tr>
                    ...
                    <td><?php echo $result[$k]["modelo"]; ?></td>
                    <td><?php echo $result[$k]["talla"]; ?></td>
                    <td><?php echo $result[$k]["color"]; ?></td>
                    <td><?php echo $result[$k]["precioOrigen"]; ?></td>
                    <td><?php echo $result[$k]["porcentajeGanancia"]; ?></td>
                    <td><?php echo $result[$k]["precioVenta"]; ?></td>
                  ...
                  switch ($action) {
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=Zapatilla-edit&codigoZapatilla=<?php echo $result[$k]["codigoZapatilla"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=Zapatilla-delete&codigoZapatilla=<?php echo $result[$k]["codigoZapatilla"]; ?>">
