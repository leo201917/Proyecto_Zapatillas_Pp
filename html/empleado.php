...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=Empleado-add"><img src="../image/icon-add.png" />Agregar Empleado</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO EMPLEADO</strong></th>
            ...
            <tbody>
                    ...
                    if (! empty($result)) {
                        foreach ($result as $k => $v) {
                            ?>
          <tr>
                    <td><?php echo $result[$k]["codigoEmpleado"]; ?></td>
                    <td><?php echo $result[$k]["codigoCargo"]; ?></td>
                    ...
                    <td><?php echo $result[$k]["sueldo"]; ?></td>
                  ...
                  <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=Empleado-edit&codigoEmpleado=<?php echo $result[$k]["codigoEmpleado"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=Empleado-delete&codigoEmpleado=<?php echo $result[$k]["codigoEmpleado"]; ?>">
