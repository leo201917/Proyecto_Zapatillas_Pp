...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=Proveedor-add"><img src="../image/icon-add.png" />Agregar Proveedor</a>
        </div>
        <div id="toys-grid">
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO PROVEEDOR</strong></th>
            ...
            <tbody>
                    ...
                    if (! empty($result)) {
                        foreach ($result as $k => $v) {
                            ?>
          <tr>
                    <td><?php echo $result[$k]["codigoProveedor"]; ?></td>
                    <td><?php echo $result[$k]["razonSocial"]; ?></td>
                    <td><?php echo $result[$k]["telefono"]; ?></td>
                    <td><?php echo $result[$k]["correo"]; ?></td>
                    <td><?php echo $result[$k]["direccion"]; ?></td>
                  ...
                  switch ($action) {
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=Proveedor-edit&codigoProveedor=<?php echo $result[$k]["codigoProveedor"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=Proveedor-delete&codigoProveedor=<?php echo $result[$k]["codigoProveedor"]; ?>">
