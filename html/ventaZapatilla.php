...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        <?php 
         require_once "../model/VentaZapatilla.php";
        $db_handle = new DBController();
        $ventazapatilla = new VentaZapatilla();
        $result = $ventazapatilla->getallVentaZapatilla();
        require_once "../html/ventaZapatilla.php";
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=VentaZapatilla-add"><img src="../image/icon-add.png" />Agregar Venta de Zapatilla</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO VENTA</strong></th>
                    <th><strong>EMPRESA FACTURAR</strong></th>
                    <th><strong>CLIENTE</strong></th>
                    <th><strong>FECHA EMISION</strong></th>
                    <th><strong>ESTADO COMPROBANTE</strong></th>
            ...
            <tbody>
                    ...
                    if (! empty($result)) {
                        foreach ($result as $k => $v) {
                            ?>
          <tr>
                    <td><?php echo $result[$k]["codigoVentaZapatilla"]; ?></td>
                    <td><?php echo $result[$k]["codigoEmpresaFacturar"]; ?></td>
                    <td><?php echo $result[$k]["codigoCliente"]; ?></td>
                    <td><?php echo $result[$k]["fechaEmision"]; ?></td>
                    <td><?php echo $result[$k]["estadoComprobante"]; ?></td>
                    <td><?php echo $result[$k]["tipoMoneda"]; ?></td>
                    <td><?php echo $result[$k]["Monto"]; ?></td>
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=VentaZapatilla-edit&codigoVentaZapatilla=<?php echo $result[$k]["codigoVentaZapatilla"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a 
                        href="../config/PrincipalAcciones.php?action=VentaZapatilla-report&codigoVentaZapatilla=<?php echo $result[$k]["codigoVentaZapatilla"]; ?> " target="_blank">
                        <img src="../image/icon-reporte.png" />
                        </a>
                    </td>
