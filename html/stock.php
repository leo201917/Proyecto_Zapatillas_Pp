...
<div class="row match-height">
    <div class="col-xl-12 col-md-12 col-sm-12">
        ...
        ?>
          <a id="btnAddAction" href="../config/PrincipalAcciones.php?action=Stock-add"><img src="../image/icon-add.png" />Agregar Stock</a>
        </div>
        <div id="toys-grid">
        ...
        <table cellpadding="10" cellspacing="1">
            <thead>
                <tr>
                    <th><strong>CODIGO STOCK</strong></th>
                    <th><strong>ZAPATILLA</strong></th>
                    <th><strong>STOCK MINIMO</strong></th>
                    <th><strong>STOCK MAXIMO</strong></th>
                    <!-- <th><strong>STOCK ACTUAL</strong></th> -->
            ...
            <tbody>
                    ...
                    if (! empty($result)) {
                        foreach ($result as $k => $v) {
                            ?>
          <tr>
                    <td><?php echo $result[$k]["codigoStock"]; ?></td>
                    <td><?php echo $result[$k]["codigoZapatilla"]; ?></td>
                    <td><?php echo $result[$k]["stockMinimo"]; ?></td>
                    <td><?php echo $result[$k]["stockMaximo"]; ?></td>
                    <!-- <td><?php echo $result[$k]["stockActual"]; ?></td> -->
                  ...
                  switch ($action) {
                    case "Stock-edit":
                      ...
                      if (isset($_POST['add'])) {
                          ...
                          $stock->editStock($codigoZapatilla, $stockMinimo, $stockMaximo, $stockActual, $codigoStock);                      
                      }
                    ...
                    <td><a class="btnEditAction" 
                        href="../config/PrincipalAcciones.php?action=Stock-edit&codigoStock=<?php echo $result[$k]["codigoStock"]; ?>">
                        <img src="../image/icon-edit.png" />
                        </a>
                        <a onclick="return confirm('Confirma Eliminar Registro?');" class="btnDeleteAction" 
                        href="../config/PrincipalAcciones.php?action=Stock-delete&codigoStock=<?php echo $result[$k]["codigoStock"]; ?>">
